...
export default function Home() {
  return (
    <>
      <Head>
        <title>Empower Digital Transformation with ICT Expertise</title>
        <meta name="description" content="Navigate ICT complexities with Cloud Zest's tailored services. Optimize infrastructure, security & more for confident digital growth. Get a quote now." />
      </Head>
      <Layout>
          ...
          <ScrollAnimationWrapper>
            <div className="grid grid-flow-row sm:grid-flow-col grid-rows-2 md:grid-rows-1 sm:grid-cols-2 gap-8 py-6 sm:py-16">
              <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1 -mt-20 lg:mt-0">
                ...
                Empower Digital Transformation with ICT Expertise
                </h1>
